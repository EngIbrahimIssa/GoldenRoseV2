...
class ItemProductRelated extends StatefulWidget {
  final ProductDetailsModel? product;
  final int index;
  final bool forWishlist;
  final bool horizontal;

  ItemProductRelated(this.product, this.index,
      {Key? key, required this.forWishlist, required this.horizontal})
      : super(key: key);

  @override
  State<ItemProductRelated> createState() => _ItemProductRelatedState();
}

class _ItemProductRelatedState extends State<ItemProductRelated> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if(widget.product?.hasOptions == true)CustomText('متوفر بعدة خيارات'.tr),
                        const SizedBox(
                          height: 5,
                        ),
                        Row(
